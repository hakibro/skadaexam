{{-- filepath: resources\views\layouts\template.blade.php --}}
<!DOCTYPE html>
<html lang="en">
...
<head>
    ...
    <title>@yield('title', 'Template Sesi') - {{ config('app.name', 'SKADA Exam') }}</title>
    ...
    <div class="flex h-screen bg-gray-100">
        ...
        <div class="bg-gray-800 text-white w-64 space-y-6 py-7 px-2 absolute inset-y-0 left-0 transform -translate-x-full md:relative md:translate-x-0 transition duration-200 ease-in-out overflow-y-auto h-screen"
            ...
            <nav class="mt-8">
                ...
                <a href="{{ route('naskah.panduan.format-docx') }}"
                    class="flex items-center space-x-2 px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('naskah.panduan.format-docx') ? 'bg-indigo-600 text-white' : '' }}">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <header class="bg-white shadow-sm">
                <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                    ...
                    <!-- Page Title -->
                    <div>
                        <h1 class="text-2xl font-semibold text-gray-900">@yield('page-title', 'Template Sesi')</h1>
                        <p class="text-sm text-gray-600">@yield('page-description', 'Manajemen Template Sesi')</p>
                    </div>
