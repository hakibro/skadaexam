            ...
            <nav class="mt-8">
                ...
                @if ($isAdmin)
                    ...
                    <a href="{{ route('naskah.paket-ujian.index') }}"
                        class="flex items-center space-x-2 px-4 py-2 text-gray-300 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('naskah.paket-ujian.*') ? 'bg-purple-600 text-white' : '' }}">
        ...
        @if ($hasRuanganAccess)
            <div class="space-y-1">
                ...
                <a href="{{ route('ruangan.cetak-sesi.index') }}"
                    class="flex items-center space-x-2 px-6 py-1 text-gray-400 hover:bg-gray-700 hover:text-white transition-colors {{ request()->routeIs('ruangan.cetak-sesi.*') ? 'bg-red-600 text-white' : '' }}">
                    <i class="fa-solid fa-print text-sm"></i>
                    <span class="text-sm">Cetak Sesi Ruangan</span>
                </a>
            </div>
        @endif
        <!-- Settings -->
