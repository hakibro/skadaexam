        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-green-500">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-gray-800" id="active-sessions">{{ $stats['active_sessions'] }}
                        </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-blue-500">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-gray-800" id="active-students">{{ $stats['active_students'] }}
                        </div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-yellow-500">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-gray-800" id="issues-count">{{ $stats['issues'] }}</div>
            ...
            <div class="bg-white rounded-lg shadow-lg p-6 border-l-4 border-purple-500">
                <div class="flex items-center">
                    ...
                    <div>
                        <div class="text-3xl font-bold text-gray-800" id="online-proctors">{{ $stats['online_proctors'] }}
                        </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            ...
                            <div class="flex items-center space-x-2">
                                <span
                                    class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium {{ $session->status_badge_class }}">
                                        ...
                                        <div class="space-y-2" id="session-{{ $session->id }}-students-list">
                                            @foreach ($session->sesiRuanganSiswa as $siswaSession)
                                                <div
                                                    ...
                                                    <div class="flex items-center">
                                                        <span
                                                            class="w-2 h-2 rounded-full mr-2 {{ $siswaSession->status_dot_class }}"></span>
                                                        <span class="font-medium">{{ $siswaSession->siswa->nama }}</span>
                                                    </div>
                                                    <div class="flex items-center space-x-2">
                                                        <span
                                                            class="text-xs px-2 py-1 rounded {{ $siswaSession->status_badge_class }}">
                                                            {{ ucfirst($siswaSession->status) }}
                                                        </span>
                                                        @if ($siswaSession->last_activity)
                                                            <span class="text-xs text-gray-500">
                                                                {{ $siswaSession->last_activity->diffForHumans() }}
                                                            </span>
                                                        @endif
                                                    </div>
                                                </div>
