                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            @foreach ($sesiRuangans as $sesi)
                                <tr class="hover:bg-gray-50">
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div class="flex items-center">
                                            <input type="checkbox" name="session_ids[]" value="{{ $sesi->id }}"
                                                class="session-checkbox rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                                            <span class="ml-2">{{ $sesi->nama_sesi }}</span>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">{{ $sesi->ruangan->nama_ruangan ?? 'Unknown' }}
                                    </td>
                                    <td class="px-4 py-4 whitespace-nowrap">
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap">
                                        <div id="pengawas-display-{{ $sesi->id }}">
                                            @if ($sesi->pengawas_for_jadwal)
                                                <div class="flex items-center">
                                                    <span
                                                        class="font-medium text-gray-900">{{ $sesi->pengawas_for_jadwal->nama }}</span>
                                                </div>
                                            @else
                                    ...
                                    <td class="px-4 py-4 whitespace-nowrap text-sm">
                                        <div class="flex space-x-2">
                                            <button type="button"
                                                class="assign-pengawas px-3 py-1 bg-blue-600 text-white rounded hover:bg-blue-700"
                                            ...
                                            @if ($sesi->pengawas_for_jadwal)
                                                <button type="button"
                                                    class="remove-pengawas px-3 py-1 bg-red-600 text-white rounded hover:bg-red-700"
                                                    data-sesi-id="{{ $sesi->id }}"
                                                    data-jadwal-id="{{ $selectedJadwal->id }}">
