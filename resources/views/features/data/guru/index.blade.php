...
@section('content')
    <div class="space-y-6">
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                ...
                <div class="md:col-span-3">
                    ...
                    <select id="role-filter"
                        ...
                        @foreach (App\Models\Guru::getRoleOptions() as $value => $label)
        ...
        <!-- Search Results Info -->
        <div id="search-info" class="bg-blue-50 border border-blue-200 rounded-lg p-3 {{ request('q') ? '' : 'hidden' }}">
    ...
    <!-- Fixed JavaScript for Search and Filter -->
    <script>
            ...
            document.addEventListener('click', function(e) {
                ...
                if (paginationLink) {
                    ...
                    if (page) {
                        ...
                        // Debug log
                        console.log('Paginating with URL:', paginationUrl.toString());
