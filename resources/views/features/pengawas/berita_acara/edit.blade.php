...
@section('page-description', 'Perbarui laporan pelaksanaan ujian')
...
@section('content')
    <div>
        ...
        <form action="{{ route('pengawas.berita-acara.update', $sesiRuangan->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="bg-white rounded-lg shadow-lg p-6">
                <div class="border-b border-gray-200 pb-4 mb-6">
                    <h2 class="text-2xl font-bold text-green-700">
                        ...
                        Edit Berita Acara Ujian
                    </h2>
                    <p class="text-gray-600 mt-1">Perbarui laporan pelaksanaan ujian untuk sesi ini</p>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="catatan_pembukaan" name="catatan_pembukaan" rows="3"
                            ...
                            placeholder="Catatan terkait pembukaan ujian, seperti persiapan ruangan, briefing siswa, dll.">{{ old('catatan_pembukaan', $beritaAcara->catatan_pembukaan) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="catatan_pelaksanaan" name="catatan_pelaksanaan" rows="3"
                            ...
                            placeholder="Catatan terkait pelaksanaan ujian, seperti kendala teknis, kejadian khusus, dll.">{{ old('catatan_pelaksanaan', $beritaAcara->catatan_pelaksanaan) }}</textarea>
                    ...
                    <div>
                        ...
                        <textarea id="catatan_penutupan" name="catatan_penutupan" rows="3"
                            ...
                            placeholder="Catatan terkait penutupan ujian, seperti saran perbaikan, dll.">{{ old('catatan_penutupan', $beritaAcara->catatan_penutupan) }}</textarea>
                    ...
                    <div>
                        ...
                        <select id="status_pelaksanaan" name="status_pelaksanaan" required
                            ...
                            <option value="" disabled>-- Pilih Status Pelaksanaan --</option>
                            <option value="selesai_normal"
                                {{ old('status_pelaksanaan', $beritaAcara->status_pelaksanaan) == 'selesai_normal' ? 'selected' : '' }}>
                                Selesai Normal</option>
                            <option value="selesai_terganggu"
                                {{ old('status_pelaksanaan', $beritaAcara->status_pelaksanaan) == 'selesai_terganggu' ? 'selected' : '' }}>
                                Selesai Terganggu</option>
                            <option value="dibatalkan"
                                {{ old('status_pelaksanaan', $beritaAcara->status_pelaksanaan) == 'dibatalkan' ? 'selected' : '' }}>
                                Dibatalkan</option>
                        </select>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                            ...
                            <div>
                                ...
                                <input type="number" id="jumlah_peserta_terdaftar" name="jumlah_peserta_terdaftar"
                                    value="{{ old('jumlah_peserta_terdaftar', $beritaAcara->jumlah_peserta_terdaftar) }}"
                                    min="0" required
                            ...
                            <div>
                                ...
                                <input type="number" id="jumlah_peserta_hadir" name="jumlah_peserta_hadir"
                                    value="{{ old('jumlah_peserta_hadir', $beritaAcara->jumlah_peserta_hadir) }}"
                                    min="0" required
                            ...
                            <div>
                                ...
                                <input type="number" id="jumlah_peserta_tidak_hadir" name="jumlah_peserta_tidak_hadir"
                                    value="{{ old('jumlah_peserta_tidak_hadir', $beritaAcara->jumlah_peserta_tidak_hadir) }}"
                                    min="0" required
...
@section('scripts')
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            // Trigger status change event on load to show help text if needed
